...
input[type="text"], input[type="file"], input[type="datetime-local"], select, textarea {
    width: 100%;
    padding: 14px;
    margin-bottom: 20px;
...
input[type="text"]:focus, input[type="file"]:focus, input[type="datetime-local"]:focus, select:focus, textarea:focus {
    border-color: #6200ea;
    background-color: #ffffff;
...
/* Mise en page flexible pour les colonnes */
.form-row {
    display: flex;
...
/* Ajustement de la hauteur des zones de texte */
textarea {
    height: 180px;
    resize: vertical;
}
...
/* Styles supplémentaires pour le formulaire complet */
.form-container h2 {
    font-size: 2rem;
    font-weight: bold;
    color: #444;
...
@media (max-width: 768px) {
    /* Pour les écrans plus petits, nous empilons les champs en une seule colonne */
    .form-row {
        ...
        <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-column">
                    <div>
                        <label for="title"><h6>Titre de l'article</h6></label>
                        <input type="text" id="title" name="title" required placeholder="Entrez le titre de l'article" aria-required="true" aria-describedby="titleHelp" style="width:500px">
                        <small id="titleHelp">Assurez-vous d'un titre clair et concis.</small>
                    </div>

                    <div>
                        <label for="author"><h6>Auteur</h6></label>
                        <input type="text" id="author" name="name" required placeholder="Entrez votre nom" aria-required="true" value="{{ Auth::user()->name }}">
                    </div>

                    <div>
                        <label for="excerpt"><h6>Extrait</h6></label>
                ...
                <div class="form-column">
                    <div>
                        <label for="content"><h6>Contenu de l'article</h6></label>
                    ...
                    <div>
                        <label for="category"><h6>Catégorie de l'article</h6></label>
                    ...
                    <div>
                        <label for="image"><h6>Image de l'article</h6></label>
            ...
            <div>
                <label for="datetime"><h6>Date et Heure de publication</h6></label>
